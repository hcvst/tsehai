...
class Points:
    def validate_quizz_taken(self, context):
    ...
    def points_medals_brain(self, context):
        ...
        self.update_percentage(validatemedal,percentage)
    ...
    def update_percentage(self, validate_percentage_element,percentage):
    ...
    def update_reading_level(self, update, context):
